...
export default function ChallengesAdmin() {
    ...
    const [availableCategories, setAvailableCategories] = useState<string[]>(["Linux", "Docker", "Kubernetes", "Security"]);
                    ...
                    <div className="mobile-controls" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem", gap: "1rem" }}>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                            ...
                            >
                                ...
                                {Array.from(new Set([...availableCategories, ...challenges.flatMap(c => c.tags || [])])).filter(cat => cat !== "Bash" && cat !== "DevOps").sort().map(cat => (
